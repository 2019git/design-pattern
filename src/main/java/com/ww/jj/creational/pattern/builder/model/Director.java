...
public class Director {
    ...
    public enum BuilderType{
        BUILDER1(1, com.ww.jj.creational.pattern.builder.model.ConcreteBuilder1.class),
        BUILDER2(2, com.ww.jj.creational.pattern.builder.model.ConcreteBuilder2.class);
